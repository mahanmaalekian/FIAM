...
The main file to run is `final_strategy.py` which selects the monthly stocks to short/long for the Out Of Sample period (2015-01 - 2025-06) and saves this portfolio to a csv file.
