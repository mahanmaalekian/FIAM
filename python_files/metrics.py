...
PRED_PATH = "data/final_results.csv"
pred = pd.read_csv(PRED_PATH, parse_dates=["date"])
pred = pred[pred["returns"] != 0]


PAIRS_COUNT_PATH = "data/pairs-trade-counts-per-month.csv"
...
# This block simply puts the date into the right format and drops columns that won't be used
pairs_trades_count["year"] = pairs_trades_count["date"].dt.year
pairs_trades_count["month"] = pairs_trades_count["date"].dt.month

PAIRS_PATH = "data/pair-trade-per-month.csv"
...
SNP_RETURNS_PATH = "data/mkt_ind.csv"
...
# create final monthly portfolio from the pairs trades and the portfolio generated by xgboost
...
ALL_RESULTS_PATH = "data/actual_pred_per_stock.csv"  # <-- make sure this file exists
...
for year in range(2014, 2025):
    ...
    model_path = f"data/final-strat-model-{year}.joblib"
